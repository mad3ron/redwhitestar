...
<div class="top-bar -mx-4 px-4 md:mx-0 md:px-0">
        ...
        <div class="search-result">
            {{-- <div class="search-result__content">
                ...
                <div class="mb-5">
                    ...
                    <a href="" class="flex items-center mt-2">
                        <div class="w-8 h-8 image-fit">
                            <img alt="Midone - HTML Admin Template" class="rounded-full" src="{{ asset('dist/images/profile-4.jpg') }}">
                        </div>
                ...
                <a href="" class="flex items-center mt-2">
                    <div class="w-8 h-8 image-fit">
                        <img alt="Midone - HTML Admin Template" class="rounded-full" src="{{ asset('dist/images/preview-7.jpg') }}">
                    </div>
    ...
    <div class="intro-x dropdown w-8 h-8">
        <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in" role="button" aria-expanded="false" data-tw-toggle="dropdown">
            {{-- <img class="h-12 w-12 rounded-md"  alt="Midone - HTML Admin Template" src="{{ Storage::url($user->image) }}"> --}}
        </div>
        <div class="dropdown-menu w-56">
            <ul class="dropdown-content bg-primary text-white">
                <li class="p-2">
                    <div class="font-medium">{{ Auth::user()->name }}</div>
                    <div class="text-xs text-white/70 mt-0.5 dark:text-slate-500">{{ Auth::user()->role_id }} </div>
                </li>
                <li>
                ...
                <li>
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        this.closest('form').submit()" class="dropdown-item hover:bg-white/5"> <i data-lucide="toggle-right" class="w-4 h-4 mr-2"></i> {{ __('Log Out') }} </a>
                    </form>
                </li>
            </ul>
        </div>
