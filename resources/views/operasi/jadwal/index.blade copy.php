    ...
    <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
        ...
        <div class="w-full xl:w-auto flex items-center mt-3 xl:mt-0">
            ...
            <form method="GET" action="{{ route('jadwal.index') }}">
                ...
                {{-- <input type="text" name="tanggal" id="tanggal" class="datepicker form-control w-40 box pr-10" data-single-mode="true"
                placeholder="Pilih tanggal mulai" value="{{ Request::get('tanggal') }}"> --}}
                    ...
                    {{-- <div class="card-header"> --}}
                        {{-- <form method="GET" action="{{ route('jadwal.index') }}"> --}}
                            ...
                            {{-- <div class="form-group"> --}}
                                {{-- <a href="{{ route('jadwal.create') }}" class="btn btn-primary">Create</a> <!-- Tambahkan baris ini --> --}}
                                {{-- <label for="tanggal">Pilih Tanggal:</label> --}}
                                {{-- <input type="date" id="tanggal" name="tanggal" value="{{ date('Y-m-d') }}"> --}}
                                {{-- <input type="date" id="tanggal" name="tanggal" class="form-control" value="{{ Request::get('tanggal') }}"> --}}
                            {{-- </div> --}}
