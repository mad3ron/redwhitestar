<x-app-layout>
                ...
                <form action="{{ route('biodatas.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-12 gap-4 gap-y-5">
                        <div class="intro-y col-span-12 sm:col-span-6">
                            ...
                            <input id="nik" name="nik" type="text" value="{{ old('nik') }}" class="form-control" minlength="16" required @error('nik') is-invalid @enderror>
                        ...
                        <div class="intro-y col-span-12 sm:col-span-6">
                            ...
                            <input id="nokk" name="nokk" type="text" value="{{ old('nokk') }}" class="form-control" minlength="16" required>
                            @error('nokk')
                                <div class="sm:ml-auto mt-1 sm:mt-0 text-sm text-red-500">Data Sudah Ada</div>
                            @enderror
                        </div>
                        <div class="intro-y col-span-12 sm:col-span-6">
                            ...
                            <input id="nama" name="nama" type="text" value="{{ old('nama') }}" class="form-control" minlength="3" required>
                        </div>
                        <div class="intro-y col-span-12 sm:col-span-6">
                            ...
                            <select id="kotalahir_id" name="kotalahir_id" class="tom-select" required>
                                ...
                                @if (count($kotalahirs) > 0)
                                    @foreach ($kotalahirs as $kotalahir)
                                        <option value="{{ $kotalahir->id }}" {{ old('kotalahir_id') == $kotalahir->id ? 'selected' : '' }}>
                        ...
                        <div class="intro-y col-span-12 sm:col-span-6">
                            ...
                            <input id="tgl_lahir" name="tgl_lahir" type="date" value="{{ old('tgl_lahir') }}" class="form-control" required>
                        </div>
                        <div class="intro-y col-span-12 sm:col-span-6">
                        ...
                        <div class="intro-y col-span-12 sm:col-span-6">
                            ...
                            <input id="alamat" name="alamat" type="text" value="{{ old('alamat') }}" class="form-control" minlength="3" required>
                        </div>
                        <div class="intro-y col-span-12 sm:col-span-6">
                            <label class="form-label">RT</label>
                            <input id="rt" name="rt" type="number" value="{{ old('rt') }}" class="form-control" minlength="1" required>
                        </div>
                        <div class="intro-y col-span-12 sm:col-span-6">
                            <label class="form-label">RW</label>
                            <input id="rw" name="rw" type="number" value="{{ old('rw') }}" class="form-control" minlength="1" required>
                        </div>
                        <div class="intro-y col-span-12 sm:col-span-6">
                            <label class="form-label">Kelurahan</label>
                            <select id="kelurahan_id" name="kelurahan_id" class="tom-select" data-tags="true">
                                <option value="">Select Kelurahan</option>
                                @foreach ($kelurahans as $kelurahan)
                                    <option value="{{ $kelurahan->id }}">{{ $kelurahan->name }} - {{ $kelurahan->kecamatan }} - {{ $kelurahan->kabkota }}
                                    </option>
                                @endforeach
                            </select>
                            @error('kelurahan_id')
                        ...
                        <div class="intro-y col-span-12 sm:col-span-6">
                            ...
                            <input id="phone" name="phone" type="text" value="{{ old('phone') }}" class="form-control" minlength="10" required>
                        </div>
                        <div class="intro-y col-span-12 sm:col-span-6">
                        ...
                        <div class="intro-y col-span-12 sm:col-span-6">
                            ...
                            <select id="is_visible" name="is_visible" data-search="true" class="tom-select" required>
                                <option value="Active" {{ old('is_visible') == 'Active' ? 'selected' : '' }}>Active</option>
                                <option value="Inactive" {{ old('is_visible') == 'Inactive' ? 'selected' : '' }}>Inactive</option>
                                <option value="Disable" {{ old('is_visible') == 'Disable' ? 'selected' : '' }}>Disable</option>
                            </select>
                        </div>
                        ...
                        <div class="mt-5 sm:mt-10">
                            <button id="biodata-submit" type="submit" class="btn btn-primary mr-2">Simpan</button>
    ...
    <script>
        ...
        // var kotalahirSelect = document.getElementById("kotalahir_id");
        // var kotalahirOtherDiv = document.getElementById("kotalahir-other");

        // kotalahirSelect.addEventListener("change", function() {
        //     if (kotalahirSelect.value === "other") {
        //         kotalahirOtherDiv.style.display = "block";
        //     } else {
        //         kotalahirOtherDiv.style.display = "none";
        //     }
        // });
